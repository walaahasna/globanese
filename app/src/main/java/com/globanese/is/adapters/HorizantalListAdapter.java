 ...
 */
public class HorizantalListAdapter extends RecyclerView.Adapter<HorizantalListAdapter.MyViewHolder> {
    Context context;
    List<AddFriendObject> Friends;
    MyRecyclerViewListener listener;
    ImageLoader imageLoader;

    public HorizantalListAdapter() {
    }
    ...
    public HorizantalListAdapter(Context context, List<AddFriendObject> Friends) {
