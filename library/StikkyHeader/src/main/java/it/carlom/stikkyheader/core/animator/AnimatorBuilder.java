...
public class AnimatorBuilder {
    ...
    public AnimatorBuilder applyFade2(View viewToFade, float fadeFrom, float fadeTo, Interpolator interpolator) {
        if (viewToFade == null) {
            throw new IllegalArgumentException("You passed a null view");
        }

//        float startAlpha = StikkyCompat.getAlpha(viewToFade);
        addAnimator(AnimatorBundle.create(AnimatorBundle.TypeAnimation.FADE, viewToFade, interpolator, fadeFrom, fadeTo));
